...
public class BattleGameComputerGridPanel extends JPanel {
    ...
    public void setComputerGridComponents(SizeDto size) {
        setButtons(size);
    }

    public void setComputerGridPanel(SizeDto size) {
        removeAll();

        ComponentSetter.setPanel(this, 500, 500, 960, 280, new GridLayout(size.size(), size.size()));
